...
@Component({
  selector: 'app-real-estate-manag',
  standalone: true,
  imports: [BusinessInsustrySubmenu, CommonModule, RouterLink],
  templateUrl: './real-estate-manag.html',
  styleUrl: './real-estate-manag.css',
})
export class RealEstateManag implements OnInit {
  ...
  ngOnInit() {
    ...
    const album = {
      src: "assets/images/dashboard/realestate.png?v=" + this.$rootScope.version,
      caption: "Property status summary",
      thumb: "assets/images/dashboard/realestate.png"
    };
