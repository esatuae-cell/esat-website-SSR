...
@Component({
  ...
  templateUrl: './budget-project.html',
  styleUrl: './budget-project.css',
})
export class BudgetProject implements OnInit {
  ...
  ngOnInit() {
    ...
    const album = {
      src: "assets/images/dashboard/budget.png?v=" + this.$rootScope.version,
      caption: "Item expense - Costcode wise",
      thumb: "assets/images/dashboard/budget.png"
    };
