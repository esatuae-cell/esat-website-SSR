...
@Component({
  ...
  templateUrl: './hcm.html',
  styleUrl: './hcm.css',
})
export class Hcm implements OnInit {
  ...
  ngOnInit() {
    ...
    const album = {
      src: "assets/images/dashboard/hcm.png?v=" + this.$rootScope.version,
      caption: "Active employees - Nationality wise",
      thumb: "assets/images/dashboard/hcm.png"
    };
